...
For key, path in argarr{
    ...
    inarr:=[]
    outarr:=[]
    inarr["TencentSecretId1"] := ""
    inarr["TencentTranKey1"] := ""
    inarr["待译文本"] := "hello,world!r34"
    inarr[""] := ""
    inarr[""] := ""
    outarr["翻译结果"] := "待返回"
    outarr[""] := ""
    ...
    inarr["TencentSecretId1"] := arrupdatefromconfigini(inarr["TencentSecretId1"], "ApiKeys", "TencentSecretId1") 
