...
#输入文本
inarr["输入文本"]="武侯区红牌楼街道19号红星大厦9楼2号"
inarr[""]=""
inarr[""]=""
inarr[""]=""
inarr[""]=""
...
def main(fd2={}):
    ...
    #inarr 输入文本    
    #outarr province city county detail full_location
    #fkeyold  fkeynew  
    try:  # 运行函数,最后要生成arr2ret及f64
        ...
        print(res)
        arr2ret["province"]=res["province"]
        arr2ret["city"]=res["city"]
        arr2ret["county"]=res["county"]
        arr2ret["full_location"]=res["full_location"]
