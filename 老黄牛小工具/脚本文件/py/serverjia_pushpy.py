...
def send_message(sendkey, title, desp=''):
    # 构建请求的URL
...
#输入文本
inarr["title"]="r34.cc标题"
inarr["desp"]="r34.cc具体内容"
inarr["sendkey"]="请先申请key"
inarr[""]=""
inarr[""]=""
outarr["state"] = "待返回"
outarr[""] = ""
...
def main(fd2={}):
    ...
    #inarr title desp sendkey  
    #inarr state    
    #fkeyold  fkeynew  
    try:  # 运行函数,最后要生成arr2ret及f64

        arr2ret["state"]=send_message(valarr["sendkey"],valarr["title"],valarr["desp"])
