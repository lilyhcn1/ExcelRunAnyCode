...
def main():
    ...
    try:
        appid=lilyfun.readini("ApiKeys","TencentSecretId1")
        appkey=lilyfun.readini("ApiKeys","TencentsecretKey1")
        cred = credential.Credential(appid, appkey)#腾讯云api密钥 https://console.cloud.tencent.com/cam/capi
        ...
        params = {
            ...
            "Source": "auto",#语种自动识别
            "Target": "ko",#zh-简体中文 en-英语 ja-日语 ko-韩语
            "ProjectId": 0
        }
