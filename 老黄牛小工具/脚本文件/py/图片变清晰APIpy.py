...
outarr[""] = ""
#文件标志
fkeyold="模糊图片地址"   #输入变量中，哪个是文件的标记。
fkeynew="清晰图片地址"   #输出变量中，哪个是文件的标记。
#2222222222222222222222222222222222222222222222222222222222222
...
def main(fd2={}):
    ...
    try:  # 运行函数,最后要生成arr2ret及f64
        ...
        exestr =  "D:\\老黄牛小工具\\小工具\\realesrgan图片变清晰\\soft\\realesrgan-ncnn-vulkan.exe" + " -i "+ old_filepath + " -o "+new_filepath + " -n realesrgan-x4plus"
        exestr = "\"" + exestr + "\""
