...
def convert_to_icon(image_path, icon_path):
    ...
    img.save(icon_path, format='ICO', sizes=[(123,123)])
...
inarr[""]=""
inarr[""]=""
inarr["ico地址"]="D:\\老黄牛小工具\\ExcelQuery\\temp\\temp.ico"
outarr[""] = ""
outarr[""] = ""
outarr[""] = ""
outarr[""] = ""
...
def main(fd2={}):
    ...
    #inarr 图片地址    ico地址
    #inarr     
    #fkeyold 图片地址 fkeynew ico地址 
    try:  # 运行函数,最后要生成arr2ret及f64

        convert_to_icon(old_filepath, new_filepath)
