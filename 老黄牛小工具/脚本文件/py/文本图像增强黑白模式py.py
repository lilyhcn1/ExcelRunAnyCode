...
def main(fd2={}):
    ...
    #inarr TencentSecretId TencentsecretKey 图片地址 新图片地址 
    #outarr     
    #fkeyold 图片地址 fkeynew 新图片地址 
    try:  # 运行函数,最后要生成arr2ret及f64
        ...
        req = models.ImageEnhancementRequest()   ########修改这里#############
        ...
        #lilyfun.savesttxt(resp.to_json_string(),"aaaaaaaaaaaaaaaaaaa.txt")
