...
def main(fd2={}):
    ...
    #inarr TencentSecretId TencentsecretKey 待译文本  
    #inarr 译文    
    #fkeyold  fkeynew  
    try:  # 运行函数,最后要生成arr2ret及f64
        ...
        #auto：自动识别（识别为一种语言） zh：简体中文 zh-TW：繁体中文 en：英语 ja：日语 ko：韩语 fr：法语 es：西班牙语 it：意大利语 de：德语 
        # tr：土耳其语 ru：俄语 pt：葡萄牙语 vi：越南语 id：印尼语 th：泰语 ms：马来西亚语 ar：阿拉伯语 hi：印地语
