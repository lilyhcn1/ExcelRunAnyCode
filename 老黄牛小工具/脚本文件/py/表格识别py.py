...
inarr["图片地址"]="D:\\老黄牛小工具\\word模板\\表格.jpg"
inarr[""]=""
inarr[""]=""
outarr["表格地址"] = "D:\\老黄牛小工具\\word模板\\OCR表格.xlsx"
outarr[""] = ""
outarr[""] = ""
outarr[""] = ""
outarr[""] = ""
...
def main(fd2={}):
    ...
    try:  # 运行函数,最后要生成arr2ret及f64
        ...
        req = models.RecognizeTableOCRRequest()   ########修改这里#############
        params = {
            "ImageBase64":f64
        }
        ...
        tmp64 = arr["Data"]
        new_filepath=lilyfun.writefile64(tmp64,new_filepath)
        #print(new_filepath)
        #print(arr)
        #keystr=""
        #for valarr in arr:
